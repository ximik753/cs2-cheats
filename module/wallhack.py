    ...
    def Render(self):
        ...
        for entity in self.GetEntities():
            if entity.Wts(matrix) and entity.Health() > 0:
                ...
                # Box Fill
                pm.draw_rectangle(entity.headPos2d["x"] - center, entity.headPos2d["y"] - center / 2, width,
                                  head + center / 2, fill)

                # Box
                pm.draw_rectangle_lines(entity.headPos2d["x"] - center, entity.headPos2d["y"] - center / 2, width,
                                        head + center / 2, color, 0.8)
